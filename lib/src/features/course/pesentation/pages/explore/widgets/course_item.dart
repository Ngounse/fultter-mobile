...
import 'package:my_library/src/widgets/custom_image.dart';
import 'package:my_library/src/widgets/favorite_box_v2.dart';
...
class CourseItem extends StatelessWidget {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Stack(
          children: [
            _buildCourseImage(),
            Positioned(top: 170, right: 15, child: _buildFavoriteButton()),
            Positioned(top: 210, child: _buildCourseInfo()),
          ],
        ),
      ),
    );
    ...
    return BlocConsumer<FavoriteCourseBloc, FavoriteCourseState>(
      ...
      builder: (context, state) {
        return FavoriteBoxV2(
          ...
          onTap: () {
            BlocProvider.of<FavoriteCourseBloc>(
              context,
  ...
  Widget _buildCourseImage() {
    return Hero(
      ...
      child: CustomImage(course.image, width: width, height: 190, radius: 15),
    );
  }
