...
import 'package:my_library/src/features/course/pesentation/pages/course_detail/widgets/course_detail_lesson_list.dart';
...
class _CourseDetailTabBarState extends State<CourseDetailTabBar>
  ...
  Widget build(BuildContext context) {
    return Column(children: [_buildTabBar(), _buildTabBarPages()]);
  }
