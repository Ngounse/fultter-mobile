...
import 'package:my_library/core/utils/app_navigate.dart';
...
import 'package:my_library/src/features/course/pesentation/pages/course_detail/course_detail.dart';
import 'package:my_library/src/widgets/custom_progress_indicator.dart';
import 'package:my_library/src/features/course/pesentation/pages/home/widgets/feature_item.dart';
    ...
    return CarouselSlider(
      ...
      items: List.generate(
        ...
        (index) => FeatureItem(
          ...
          onTap: () {
            AppNavigator.to(context, CourseDetailPage(course: courses[index]));
          },
        ),
      ),
    );
